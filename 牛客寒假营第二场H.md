...
如上是一段计算数组权值的伪代码，通过调用 f(1,m,s)f(1,m,s)f(1,m,s) 计算一个长度为 mmm 的数组 s1,s2,…,sms_1,s_2,\dots,s_ms1​,s2​,…,sm​ 的权值，现在 Bingbong 有一个长度为 nnn 的数组 a1,a2,…,ana_1,a_2,\dots,a_na1​,a2​,…,an​，请你帮助他求出所有非空子数组的权值之和。  
